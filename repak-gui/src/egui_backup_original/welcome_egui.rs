...
fn show_support_section(ui: &mut egui::Ui) {
    let contributers: Vec<Contributer> = vec![
        ...
        Contributer {
            name: "Xzant".to_string(),
            link: "https://www.patreon.com/Xzant".to_string(),
            description: "Updating the UI and adding QoL features. Keeping the mod manager updated.".to_string(),
            platform: "Patreon".to_string(),
        },
    ];
